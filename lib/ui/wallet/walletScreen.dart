...
class WalletScreenState extends State<WalletScreen> {
  ...
  getData() async {
    ...
    withdrawHistoryQuery =
        fireStore.collection(Payouts).where('vendorID', isEqualTo: vendorId).orderBy('paidDate', descending: true).snapshots();
  }
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                decoration:
                    BoxDecoration(image: DecorationImage(fit: BoxFit.fitWidth, image: AssetImage("assets/images/wallet_img_@3x.png"))),
                    ...
                    Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(18), border: Border.all(color: Color(COLOR_PRIMARY), width: 4)),
                        child: Padding(
