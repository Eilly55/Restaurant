            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  getTextBuild('Date'.tr(),
                      "${DateFormat('MMM dd, yyyy, KK:mma').format(widget.withdrawHistoryModel.paidDate.toDate()).toUpperCase()}"),
                  getTextBuild('Status'.tr(), "${widget.withdrawHistoryModel.paymentStatus}"),
                  Visibility(
                      visible: widget.withdrawHistoryModel.note != null && widget.withdrawHistoryModel.note.isNotEmpty,
                      child: getTextBuild('Notes'.tr(), "${widget.withdrawHistoryModel.note}")),
                  Visibility(
                      visible: widget.withdrawHistoryModel.adminNote != null && widget.withdrawHistoryModel.adminNote.isNotEmpty,
                      child: getTextBuild('Admin Note'.tr(), "${widget.withdrawHistoryModel.adminNote}")),
                ],
              ),
            ),
          ),
