...
class _QrCodeGeneratorState extends State<QrCodeGenerator> {
  ...
  Future<void> saveFile(BuildContext context) async {
    ...
    final result = await ImageGallerySaver.saveImage(imageFile.readAsBytesSync(),
        quality: 100, name: 'QrCode_${widget.vendorModel.title.toString().replaceAll(RegExp('\'[^A-Za-z0-9]'), "")}.png');
