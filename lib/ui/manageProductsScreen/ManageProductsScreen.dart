...
import 'package:uber_eats_restaurant_dashboard/ui/addOrUpdateProduct/AddOrUpdateProductScreen.dart';
                      ...
                      children: <Widget>[
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: NetworkImage(productModel.photo), fit: BoxFit.cover))),
                        SizedBox(
                          width: 20,
                        ),
                        Expanded(
                              ...
                              children: <Widget>[
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 17,
                                      fontFamily: "Poppins",
                                      color: isDarkMode(context) ? Colors.white : Color.fromRGBO(0, 0, 0, 100)),
                                ),
                                SizedBox(height: 8),
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 15, fontFamily: "Poppins", color: isDarkMode(context) ? Colors.white : Color(0xff5E5C5C)),
                                ),
                                SizedBox(height: 8),
                                Row(
                                  children: [
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 15,
                                          color: isDarkMode(context) ? Colors.white : Color(0XFF768296),
                                          fontFamily: "Poppins"),
                                    )
                                  ],
                                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        style:
                            TextStyle(fontSize: 15, fontFamily: "Poppinsm", color: isDarkMode(context) ? Colors.white : Color(0xff5E5C5C)),
                      ),
                      SizedBox(
                        height: 20,
                      ),
