...
import 'package:uber_eats_restaurant_dashboard/model/SpecialDiscountModel.dart';
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          onTap: () async {
                                            ...
                                            setState(() {
                                              specialDiscount[index].timeslot![index1].from = DateFormat('HH:mm').format(DateTime(
                                                  DateTime.now().year,
                                                  DateTime.now().month,
                                                  DateTime.now().day,
                                                  startTime!.hour,
                                        ...
                                        Expanded(
                                          ...
                                          onTap: () async {
                                            ...
                                            if (startTime!.format(context).toString() == "12:00 AM") {
                                              specialDiscount[index].timeslot![index1].to = DateFormat('HH:mm')
                                                  .format(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, 23, 59));
                                            } else {
                                              setState(() {
                                                specialDiscount[index].timeslot![index1].to = DateFormat('HH:mm').format(DateTime(
                                                    DateTime.now().year,
                                                    DateTime.now().month,
                                                    DateTime.now().day,
                                                    startTime.hour,
          ...
          onPressed: () {
            if (MyAppState.currentUser!.vendorID.isEmpty) {
              ...
              specialDiscount.forEach((element) {
                var emptyList =
                    element.timeslot!.where((element) => element.discount!.isEmpty || element.from!.isEmpty || element.to!.isEmpty);
