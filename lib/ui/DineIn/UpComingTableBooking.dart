                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildDetails(
                              ...
                              title: 'Name'.tr(),
                              value: "${bookTableModel.author.firstName} ${bookTableModel.author.lastName}"),
                          ...
                          buildDetails(
                              ...
                              title: 'Discount',
                              value: "${bookTableModel.discount} ${bookTableModel.discountType == "amount" ? symbol : "%"} Off"),
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            ...
                                            FireStoreUtils.sendFcmMessage(
                                                "Booking Update".tr(), "bookingRejectedRestaurant".tr(), bookTableModel.author.fcmToken);
                                          },
                                        ),
                                      ),
                                    ),
