  ...
  factory BookTableModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    if (parsedJson['totalGuest'] == null || parsedJson['totalGuest'] == double.nan || parsedJson['totalGuest'] == double.infinity) {
      ...
      if (parsedJson['totalGuest'] is String) {
        ...
        guestVal = (parsedJson['totalGuest'] is double)
            ? (parsedJson["totalGuest"].isNaN ? 0 : (parsedJson['totalGuest'] as double).toInt())
            : parsedJson['totalGuest'];
      }
    }
    return BookTableModel(
        ...
        specialRequest: (parsedJson["specialRequest"] != null && parsedJson["specialRequest"].toString().isNotEmpty)
            ? parsedJson["specialRequest"]
            : "",
