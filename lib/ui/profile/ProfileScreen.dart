...
import 'package:uber_eats_restaurant_dashboard/ui/accountDetails/AccountDetailsScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/auth/AuthScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/settings/SettingsScreen.dart';
                      ...
                      ListTile(
                        onTap: () async {
                          ...
                          Navigator.of(context)
                              .push(new MaterialPageRoute(builder: (context) => AccountDetailsScreen(/*user: user,*/ vendor: vendor)))
                              .then((value) {
                            if (value != null) {
                              setState(() {
                                FireStoreUtils.getCurrentUser(MyAppState.currentUser!.userID).then((value) {
                  ...
                  child: ConstrainedBox(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        'Logout',
                        style:
                            TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: isDarkMode(context) ? Colors.white : Colors.black),
                      ).tr(),
                      onPressed: () async {
                        user.fcmToken = "";
