  ...
  void initState() {
    ...
    FireStoreUtils.getCurrentUser(MyAppState.currentUser!.userID).then((value) {
      setState(() {
        ...
        if (user!.userBankDetails != null && user!.userBankDetails.accountNumber.isNotEmpty) {
          title = "Edit Bank".tr();
          bankNameController =
            ...
            child: Column(
              ...
              children: [
                ...
                buildTextFiled(
                    ...
                    title: "Bank Name".tr(), controller: bankNameController),
                buildTextFiled(
                ...
                Padding(
                  ...
                  child: buildButton(context, title: title,
                      onPress: () async {
