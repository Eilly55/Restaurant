...
import 'package:uber_eats_restaurant_dashboard/ui/phoneAuth/PhoneNumberInputScreen.dart';
...
class _SignUpState extends State<SignUpScreen> {
        ...
        InkWell(
          ...
          child: /*Text(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(30), color: Colors.white, border: Border.all(color: Color(COLOR_PRIMARY), width: 1)),
            child: Padding(
  ...
  _signUpWithEmailAndPassword() async {
    if (_key.currentState?.validate() ?? false) {
      ...
      dynamic result =
          await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!);
      await hideProgress();
