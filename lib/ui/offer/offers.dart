                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            print(snapshot.data![index].offerId.toString() + "[][]");
                            push(
                              context,
                              AddOfferScreen(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: snapshot.data![index].imageOffer!.isEmpty || snapshot.data![index].imageOffer! == null
                                                ? ""
                                                : snapshot.data![index].imageOffer!,
                                            height: 100,
                                            width: 100,
                                            fit: BoxFit.cover,
                                            errorWidget: (context, url, error) => Container(
                                              ...
                                              child: Image(
                                                image: index % 2 == 0
                                                    ? AssetImage("assets/images/offer_placeholder_1.png")
                                                    : AssetImage("assets/images/offer_placeholder_2.png"),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                      child: Text(
                                                          "This offer is expire on".tr() +
                                                              " " +
                                                              getDate(snapshot.data![index].expireOfferDate!.toDate().toString())!,
                                                          style: TextStyle(
                                                              fontSize: 15,
                                                              fontFamily: "Poppins",
                                                              letterSpacing: 0.5,
