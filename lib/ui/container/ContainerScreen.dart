...
import 'package:uber_eats_restaurant_dashboard/model/User.dart';
...
import 'package:uber_eats_restaurant_dashboard/ui/DineIn/DineInRequest.dart';
import 'package:uber_eats_restaurant_dashboard/ui/Language/language_choose_screen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/addDineIn/AddDineIn.dart';
import 'package:uber_eats_restaurant_dashboard/ui/add_resturant.dart/add_resturant.dart';
import 'package:uber_eats_restaurant_dashboard/ui/auth/AuthScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/bank_details/bank_details_Screen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/manageProductsScreen/ManageProductsScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/offer/offers.dart';
import 'package:uber_eats_restaurant_dashboard/ui/ordersScreen/OrdersScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/profile/ProfileScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/special_offer_screen/SpecialOfferScreen.dart';
import 'package:uber_eats_restaurant_dashboard/ui/wallet/walletScreen.dart';
...
class ContainerScreen extends StatefulWidget {
  ...
  ContainerScreen(
      {Key? key, this.user, this.userId, this.isDineInReq, appBarTitle, currentWidget, this.drawerSelection = DrawerSelection.Orders})
...
class _ContainerScreen extends State<ContainerScreen> {
  ...
  getSpecialDiscount() async {
    await FirebaseFirestore.instance.collection(Setting).doc('specialDiscountOffer').get().then((value) {
      if (value != null) {
        specialDiscountEnable = value.data()!['isEnabled'];
      }
    });
  }
