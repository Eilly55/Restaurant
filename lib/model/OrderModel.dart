...
import 'package:uber_eats_restaurant_dashboard/model/AddressModel.dart';
import 'package:uber_eats_restaurant_dashboard/model/OrderProductModel.dart';
import 'package:uber_eats_restaurant_dashboard/model/TaxModel.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return new OrderModel(
        ...
        taxModel:
            (parsedJson.containsKey('taxSetting') && parsedJson['taxSetting'] != null) ? TaxModel.fromJson(parsedJson['taxSetting']) : null,
