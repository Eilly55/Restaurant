...
import 'package:uber_eats_restaurant_dashboard/model/BlockUserModel.dart';
import 'package:uber_eats_restaurant_dashboard/model/ChannelParticipation.dart';
import 'package:uber_eats_restaurant_dashboard/model/ChatModel.dart';
import 'package:uber_eats_restaurant_dashboard/model/ChatVideoContainer.dart';
...
import 'package:uber_eats_restaurant_dashboard/model/MessageData.dart';
...
import 'package:uber_eats_restaurant_dashboard/model/withdrawHistoryModel.dart';
import 'package:uber_eats_restaurant_dashboard/services/helper.dart';
import 'package:uber_eats_restaurant_dashboard/ui/DineIn/BookTableModel.dart';
import 'package:uber_eats_restaurant_dashboard/ui/offer/offer_model/offer_model.dart';
import 'package:uber_eats_restaurant_dashboard/ui/reauthScreen/reauth_user_screen.dart';
      ...
      if (userDocument.data() != null && userDocument.exists) {
        try {
          ...
          await firestore.collection(USERS).doc(userId).update(
              {"wallet_amount": (num.parse(userDocument.data()!['wallet_amount'].toString()) + amount)}).then((value) => print("north"));
        } catch (error) {
          print(error);
...
// or FacebookAuth.i.permissions
  ...
  static firebaseSignUpWithEmailAndPassword(
      String emailAddress, String password, File? image, String firstName, String lastName, String mobile) async {
    try {
